...
const Team = () => {
  const team = [
    { name: 'Alexander Sterling', title: 'VP Recruitment', specialty: 'Executive Placements' },
    { name: 'Victoria Ashford', title: 'Senior Recruiter', specialty: 'Luxury Hospitality' },
    { name: 'Sebastian Moore', title: 'Talent Manager', specialty: 'Culinary Specialists' },
    { name: 'Eleanor Cross', title: 'Client Director', specialty: 'Placement Support' },
    { name: 'Harrison Webb', title: 'Recruiting Lead', specialty: 'F&B Operations' },
    { name: 'Penelope Grant', title: 'Placement Specialist', specialty: 'VIP Services' },
    { name: 'Theodore Blake', title: 'Talent Scout', specialty: 'Head Chef Placements' },
    { name: 'Arabella Knight', title: 'HR Specialist', specialty: 'Candidate Vetting' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-sm font-sans font-semibold text-forest tracking-widest uppercase">Our Team</span>
            <div className="w-8 h-px bg-forest" />
          </div>
          ...
          <p className="text-lg text-stone font-sans">
            Meet the recruitment specialists with decades of combined experience in luxury hospitality and enterprise-level talent placement.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-navy font-serif leading-relaxed">
            "Our team has been handpicked for their expertise, integrity, and unwavering commitment to placing the right talent with the right organization. Every placement reflects our promise of excellence."
          </p>
          <p className="text-sm text-stone font-sans mt-4">— The REFINED Recruitment Team</p>
        </motion.div>
      </div>
    </section>
  );
