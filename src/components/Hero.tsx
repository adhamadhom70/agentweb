        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center min-h-screen">
          ...
          >
            ...
            >
              ...
              <span className="text-forest"> Redefined</span>
            </motion.h1>
            ...
            >
              Connect with the industry's most trusted talent. We specialize in placing exceptional hospitality professionals who deliver uncompromising service excellence.
            </motion.p>
            ...
            >
              <div>
                ...
                <p className="text-sm text-stone font-sans">Placements</p>
              </div>
              <div>
                <p className="text-3xl font-serif font-bold text-navy">98%</p>
                <p className="text-sm text-stone font-sans">Retention</p>
              </div>
              <div>
                <p className="text-3xl font-serif font-bold text-navy">10yrs</p>
                <p className="text-sm text-stone font-sans">Experience</p>
              </div>
            </motion.div>
              ...
              >
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-serif font-semibold text-navy">Alexandra Chen</p>
                      <p className="text-sm text-stone">Executive Chef</p>
                    </div>
                  </div>
                  <p className="text-sm text-navy leading-relaxed">
                    "Exceptional service starts with exceptional people. We find them."
                  </p>
