        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-lg text-stone font-sans leading-relaxed">
              Whether you're a candidate exploring your next opportunity or an employer seeking elite talent, we're here to help. Reach out and let's discuss how we can support your goals.
            </p>
            ...
            <div className="space-y-6 pt-8 border-t border-silver">
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-sm text-stone font-sans uppercase tracking-widest mb-1">Email</p>
                  <a
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-sm text-stone font-sans uppercase tracking-widest mb-1">Phone</p>
                  <a
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-sm text-stone font-sans uppercase tracking-widest mb-1">Address</p>
            ...
            >
              ...
              <p className="text-navy font-serif">We typically respond within 24 hours.</p>
            </motion.div>
          </motion.div>
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <option value="candidate">Exploring Career Opportunities</option>
                  <option value="employer">Hiring Top Talent</option>
